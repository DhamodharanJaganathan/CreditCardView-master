...
public class CreditCardUtils {
    ...
    private static final String PATTERN_AMEX = "^3(4|7)[0-9]{2} XXXX XXXX [0-9]{4}";
    private static final String PATTERN_VISA = "^4[0-9]{3} XXXX XXXX [0-9]{4}";
    private static final String PATTERN_MASTER = "^5[0-9]{3} XXXX XXXX [0-9]{4}";
    private static final String PATTERN_DISCOVER = "^6[0-9]{3} XXXX XXXX [0-9]{4}";
